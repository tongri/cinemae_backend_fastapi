...
show_table = {
        ...
        "columns": [
            ...
            },
            {
                "name": "busy",
                "type": FieldTypes.smallint.value,
                "constraints": Constraints.check("busy >= 0"),
                "default": "default 0",
            },
            {
                "name": "price",
...
all_tables = [
    user_table, film_table, place_table, show_table, order_table, product_table, product_order_table, token_table
]
